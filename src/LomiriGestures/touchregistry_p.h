...
#include <LomiriGestures/private/candidateinactivitytimer_p.h>
#include <LomiriGestures/private/timer_p.h>
#include <LomiriGestures/private/pool_p.h>
...
class LOMIRIGESTURES_EXPORT TouchRegistry : public QObject
{
    Q_OBJECT
public:
