...
#include <LomiriGestures/private/ucswipearea_p.h>

#include <QtQuick/private/qquickitem_p.h>

#include <LomiriGestures/private/damper_p.h>

UG_NAMESPACE_BEGIN

// Information about an active touch point
struct LOMIRIGESTURES_EXPORT ActiveTouchInfo {
...
class LOMIRIGESTURES_EXPORT ActiveTouchesInfo {
public:
...
class LOMIRIGESTURES_EXPORT UCSwipeAreaPrivate : public QQuickItemPrivate
{
...
class LOMIRIGESTURES_EXPORT UCSwipeAreaStatusListener
{
public:
