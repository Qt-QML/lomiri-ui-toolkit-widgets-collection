...
#include <LomiriMetrics/private/overlay_p.h>
#include <LomiriMetrics/private/gputimer_p.h>
...
class LOMIRI_METRICS_PRIVATE_EXPORT UMApplicationMonitorPrivate
{
public:
...
class LOMIRI_METRICS_PRIVATE_EXPORT LoggingThread : public QThread
{
public:
    LoggingThread();
...
class LOMIRI_METRICS_PRIVATE_EXPORT WindowMonitorDeleter : public QRunnable
{
public:
...
class LOMIRI_METRICS_PRIVATE_EXPORT WindowMonitorFlagSetter : public QRunnable
{
public:
...
class LOMIRI_METRICS_PRIVATE_EXPORT WindowMonitor : public QObject
{
    Q_OBJECT
