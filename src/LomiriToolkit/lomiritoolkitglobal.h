...
#ifndef LOMIRITOOLKITGLOBAL_H
#define LOMIRITOOLKITGLOBAL_H

#include <QtCore/QtGlobal>

#if defined(QT_BUILD_LOMIRITOOLKIT_LIB)
#  define LOMIRITOOLKIT_EXPORT Q_DECL_EXPORT
#else
#  define LOMIRITOOLKIT_EXPORT Q_DECL_IMPORT
#endif
...
#define UT_NAMESPACE_BEGIN          namespace LomiriToolkit {
#define UT_NAMESPACE_END            }
#define UT_PREPEND_NAMESPACE(name)  LomiriToolkit::name
#define UT_USE_NAMESPACE            using namespace LomiriToolkit;
