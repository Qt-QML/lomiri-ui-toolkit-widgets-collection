...
#include <LomiriToolkit/private/ucactionitem_p.h>
#include <LomiriToolkit/private/ucmargins_p.h>
...
class LOMIRITOOLKIT_EXPORT UCAbstractButton : public UCActionItem
{
    Q_OBJECT
