...
#include <LomiriToolkit/private/ucstyleditembase_p.h>
...
class LOMIRITOOLKIT_EXPORT UCListItem : public UCStyledItemBase
{
    Q_OBJECT
...
class LOMIRITOOLKIT_EXPORT UCListItemDivider : public QQuickItem
{
    Q_OBJECT
...
class LOMIRITOOLKIT_EXPORT UCViewItemsAttached : public QObject
{
    Q_OBJECT
    ...
    // https://bugs.launchpad.net/lomiri/+source/qtdeclarative-opensource-src/+bug/1389721
...
class LOMIRITOOLKIT_EXPORT UCListItemExpansion : public QObject
{
    Q_OBJECT
...
class LOMIRITOOLKIT_EXPORT UCDragEvent : public QObject
{
    Q_OBJECT
