...
/*!
    ...
    Lomiri design standards, thus making them visually appealing and
    ...
    specified by the Lomiri Design team.
    ...
    ListItem {
        ...
        ListItemLayout {
            id: layout
            title.text: "Hello..."
            title.color: LomiriColors.orange
            subtitle.text: "...world!"
