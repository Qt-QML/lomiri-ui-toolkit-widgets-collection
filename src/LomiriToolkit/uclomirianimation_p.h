...
#ifndef UCLOMIRIANIMATION_P_H
#define UCLOMIRIANIMATION_P_H
...
class LOMIRITOOLKIT_EXPORT UCLomiriAnimation : public QObject
{
    Q_OBJECT
...
public:
    explicit UCLomiriAnimation(QObject *parent = 0);
