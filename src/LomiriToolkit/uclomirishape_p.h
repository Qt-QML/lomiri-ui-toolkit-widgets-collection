...
#ifndef UCLOMIRISHAPE_P_H
#define UCLOMIRISHAPE_P_H
...
#include <LomiriToolkit/private/ucimportversionchecker_p.h>
#include <LomiriToolkit/private/uclomirishapetextures_p.h>
...
class LOMIRITOOLKIT_EXPORT UCLomiriShape : public QQuickItem, public UCImportVersionChecker
{
    Q_OBJECT
...
public:
    UCLomiriShape(QQuickItem* parent=0);
...
private:
    ...
    Q_DISABLE_COPY(UCLomiriShape)
};

UT_NAMESPACE_END

QML_DECLARE_TYPE(UT_PREPEND_NAMESPACE(UCLomiriShape))

#endif  // UCLOMIRISHAPE_P_H
