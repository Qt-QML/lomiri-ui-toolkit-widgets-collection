                 ...
                 ShapeNode::indexType)
{
    ...
    qsgnode_set_description(this, QLatin1String("lomirishapeoverlay"));
#endif
}
...
/*! \qmltype LomiriShapeOverlay
    \instantiates UCLomiriShapeOverlay
    \inqmlmodule Lomiri.Components
    \ingroup lomiri
    \brief Extended LomiriShape adding a colored overlay layer.

    The LomiriShapeOverlay is a rounded rectangle (based on a \l
    ...
    \endqml
*/
UCLomiriShapeOverlay::UCLomiriShapeOverlay(QQuickItem* parent)
    : UCLomiriShape(parent)
    , m_overlayX(0)
    , m_overlayY(0)
    , m_overlayWidth(0)
    , m_overlayHeight(0)
...
/*! \qmlproperty rect LomiriShapeOverlay::overlayRect
...
*/
void UCLomiriShapeOverlay::setOverlayRect(const QRectF& overlayRect)
{
...
/*! \qmlproperty color LomiriShapeOverlay::overlayColor
    \since Lomiri.Components 1.2

    This property sets the color of the overlay rectangle defined by \l overlayRect. The default
    value is transparent black.
*/
void UCLomiriShapeOverlay::setOverlayColor(const QColor& overlayColor)
{
...
QSGNode* UCLomiriShapeOverlay::createSceneGraphNode() const
{
...
void UCLomiriShapeOverlay::updateGeometry(
