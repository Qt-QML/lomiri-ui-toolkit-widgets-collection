...
/*!
    \qmltype LomiriTestCase
    \inqmlmodule Lomiri.Test 1.3
    \ingroup lomiri-test
    \brief The LomiriTestCase class expands the default TestCase class.
...
TestCase {
    ...
    */
    ...
    /*!
      \qmlmethod LomiriTestCase::flick(item, x, y, dx, dy, pressTimeout = -1, steps = -1, button = Qt.LeftButton, modifiers = Qt.NoModifiers, delay = -1)
    ...
    /*!
        \qmlmethod LomiriTestCase::mouseLongPress(item, x, y, button = Qt.LeftButton, modifiers = Qt.NoModifiers, delay = -1)
